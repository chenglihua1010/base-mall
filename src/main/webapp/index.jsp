                                ...
                                <div id="so_extra_slider_1" class="so-extraslider" >
                                    ...
                                    <div class="yt-content-slider extraslider-inner" data-rtl="yes" data-pagination="yes" data-autoplay="no" data-delay="4" data-speed="0.6" data-margin="0" data-items_column00="1" data-items_column0="1" data-items_column1="1" data-items_column2="1" data-items_column3="1" data-items_column4="1" data-arrows="no" data-lazyload="yes" data-loop="no" data-buttonpage="top">
                                        <div class="item ">
                                            ...
                                            <c:forEach items="${merchandiseSaleList}" var="merchandiseSale">
                                            ...
                                            <div class="product-layout item-inner style1 ">
                                                <div class="item-image">
                                                    <div class="item-img-info">
                                                        <a href="/index/findByGI?goodsId=${merchandiseSale.goodsId}&accountId=${user.accountId}" target="_self" title="${merchandiseSale.describe} ">
                                                            <img src="${merchandiseSale.imgs}" alt="${merchandiseSale.describe}">
                                                            </a>
                                                    </div>
                                                ...
                                                <div class="item-info">
                                                    <div class="item-title">
                                                        <a href="/index/findByGI?goodsId=${merchandiseSale.goodsId}&accountId=${user.accountId}" target="_self" title="${merchandiseSale.describe}">${merchandiseSale.describe}</a>
                                                    </div>
                                                    <div class="rating">
                                                        ...
                                                        <%--<span class="fa fa-stack"><i class="fa fa-star-o fa-stack-2x"></i></span>--%>
                                                            <span>${merchandiseSale.evacount}</span>
                                                    </div>
                                                    <div class="content_price price">
                                                        <span class="price-new product-price">$55.00</span>&nbsp;&nbsp;

                                                        <span class="price-old">${merchandiseSale.goodsPrice}</span>&nbsp;
